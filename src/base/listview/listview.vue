<template>
  <scroll class="listview" :data="data" ref="listview" :listenScroll="listenScroll" @scroll="scroll" :probeType="probeType">
    ...
    <div class="list-shortcut" @touchstart="onShortcutTouchStart" @touchmove.stop.prevent="onShortcutTouchMove">
     <ul>
       <li v-for="(item,index) in shortcutList" class="item" :key="index" :date-key="index" :class="{'current': currentIndex === index}">{{item}}</li>
     </ul>
    </div>
...
export default {
  ...
  methods: {
    ...
    onShortcutTouchStart (e) {
      let anchorIndex = getDate(e.target, 'date-key')
